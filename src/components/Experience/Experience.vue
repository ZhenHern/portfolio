...
const experienceItems: Experience[] = [
    {
        title: 'Hokenso Sdn Bhd',
        content: t('experience.experienceItems.hokenso.content'),
        profession: t('experience.experienceItems.hokenso.profession'),
        startDate: new Date('2023-12'),
        endDate: null,
        url: 'https://www.hitachi-ebworx.com/careers-hks.html',
        technologies: [
            'html',
            'phpunit',
            'microservices',
